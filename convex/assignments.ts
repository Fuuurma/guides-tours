...
import {
	...
	collectConflictRows,
	timeToMinutes,
} from "./lib/assignmentConflicts";
import type { ConflictIndexName } from "./lib/assignmentConflicts";

// Re-exported for tests — convex/__tests__/assignments.test.ts
// imports these five from "../assignments".
export {
	calculateEndTime,
	checkConflictsHelper,
	minutesToTime,
