// Analytics builders, extracted from convex/analytics.ts
// (god-module decomposition).
//
// These are the ctx-bound `build*` functions shared by the public
// queries in analytics.ts and their internal mirrors. Bodies are
// moved verbatim; see analytics.ts for the handler docs.
