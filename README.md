...
- **Backend:** 33 Convex tables, 100+ functions, 43 test files, **497 passing tests**
...
- **Testing:** Vitest (497 tests) + Playwright smoke (20+ routes)
...
- `pnpm test` — Vitest run (497 tests)
...
├── __tests__/                   # 43 test files, 497 tests
