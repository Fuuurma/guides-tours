...
- **Backend:** 33 Convex tables, 100+ functions, 48 test files, **555 passing tests**
...
- **Testing:** Vitest (555 tests) + Playwright smoke (20+ routes)
...
- `pnpm test` — Vitest run (555 tests)
...
├── __tests__/                   # 48 test files, 555 tests
