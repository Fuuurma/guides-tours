...
- **Backend:** 33 Convex tables, 100+ functions, 49 test files, **562 passing tests**
...
- **Testing:** Vitest (562 tests) + Playwright smoke (20+ routes)
...
- `pnpm test` — Vitest run (562 tests)
...
├── __tests__/                   # 49 test files, 562 tests
