...
- **Backend:** 33 Convex tables, 100+ functions, 42 test files, **461 passing tests**
...
- **Testing:** Vitest (461 tests) + Playwright smoke (20+ routes)
...
- `pnpm test` — Vitest run (461 tests)
...
├── __tests__/                   # 42 test files, 461 tests
