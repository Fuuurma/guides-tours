...
- **Backend:** 33 Convex tables, 100+ functions, 50 test files, **568 passing tests**
...
- **Testing:** Vitest (568 tests) + Playwright smoke (20+ routes)
...
- `pnpm test` — Vitest run (568 tests)
...
├── __tests__/                   # 50 test files, 568 tests
