...
- **Backend:** 33 Convex tables, 100+ functions, 38 test files, **456 passing tests**
...
- **Testing:** Vitest (456 tests) + Playwright smoke (20+ routes)
...
- `pnpm test` — Vitest run (456 tests)
...
├── __tests__/                   # 38 test files, 456 tests
