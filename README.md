...
- **Backend:** 33 Convex tables, 100+ functions, 47 test files, **551 passing tests**
...
- **Testing:** Vitest (551 tests) + Playwright smoke (20+ routes)
...
- `pnpm test` — Vitest run (551 tests)
...
├── __tests__/                   # 47 test files, 551 tests
